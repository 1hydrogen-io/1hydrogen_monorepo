...
export default function UsdbRepayContainer() {
    ...
    return (
        <Flex
            ...
            gap="16px"
        >
            <TextCus mb="10px">Repay hsUSDB</TextCus>
            ...
            />
            <LabelValueItem label={"Staked USDB UnLocked"} value={"0 USDB"} />
            <ButtonCustom
                w="full"
