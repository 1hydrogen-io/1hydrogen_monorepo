...
export default function UsdbMintVaultContainer() {
    ...
    return (
        <Flex
            ...
            gap="16px"
        >
            <TextCus mb="10px">Mint hsUSDB</TextCus>
            <InputCustom
                isFull
                w="424px"
                inputFieldProps={{
            ...
            <LabelValueItem
                label={"Staked USDB"}
                value={`${numberFormat(vaulStaked.stakedBalance)} USDB`}
            />
            <LabelValueItem
                label={"Available amount to mint"}
                value={`${numberFormat(vaulStaked.availableBalance)} USDB`}
            />
            <LabelValueItem
                label={"Staked USDB Locked"}
                value={`${numberFormat(
