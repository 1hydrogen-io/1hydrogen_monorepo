...
export const fetchWalletBalanceAction = createAsyncThunk<IWalletBalance, void>(
    "wallet/fetchWalletBalanceAction",
    async () => {
        try {
            ...
            const usdbBalance = toNumberBalance(
                usdbBalanceData as BigNumber,
                18
            );
